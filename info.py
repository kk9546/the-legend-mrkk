...
URL = "https://https://demo-rsl0.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://https://demo-rsl0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-rsl0.onrender.com".format(FQDN)
else:
    URL = "https://demo-rsl0.onrender.com/".format(FQDN)
