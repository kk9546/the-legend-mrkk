...
BOT_TOKEN = environ.get('BOT_TOKEN', "6504314433:AAED6-Mp9ftgtY8XjLBcOgN9S6QIEK2YwPk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '-1001833940312').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001887132085').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001942902498
').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kamlesh:<kamlesh@1234>@kamlesh.rjifgkd.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "kamlesh")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_funda_discussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Q3ag9nB7ttthNjdl')
TUTORIAL = environ.get('TUTORIAL', '')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001681757090'))
...
URL = "https://the-legend-mr-kk-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://the-legend-mr-kk-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://the-legend-mr-kk-bot.onrender.com".format(FQDN)
else:
    URL = "https://the-legend-mr-kk-bot.onrender.com/".format(FQDN)
